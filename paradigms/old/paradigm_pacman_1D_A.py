...
class Paradigm(ParadigmBase):
    ...
    def __init__(self, paradigm_variables):
        ...
        pacman.controlStateWithLSLStreams(['pop_rates', 'quattrocento'], channels=[0, 0]) # EMG feedback
        # pacman.controlStateWithLSLStreams(['pop_rates', 'quattrocento'], channels=[0, 64]) # force feedback
